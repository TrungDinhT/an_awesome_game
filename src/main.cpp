...
// configuration step. It creates a namespace called `an_awesome_game`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        an_awesome_game::cmake::project_name,
        an_awesome_game::cmake::project_version));// version string, acquired
